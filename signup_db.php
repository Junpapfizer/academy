<?php 
    ...
    session_start(); 
    require_once 'config/db.php';  //! มีการเพิ่มข้อมูบในฐานข้อมูล
    ...
    if (isset($_POST['signup'])) {
        ...
        if (empty($firstname)) { 
            ...
            header("location: index.php");  //? ย้อกลับไปหน้า index
            ...
            header("location: index.php");
        } else if ($password != $c_password) { //? เช็ครหัสตรงมั้ย
            ...
            try {
                ...
                if ($row['email'] == $email) {
                    ...
                    $stmt->bindParam(":password", $passwordHash); // ใช้ pass hashS
